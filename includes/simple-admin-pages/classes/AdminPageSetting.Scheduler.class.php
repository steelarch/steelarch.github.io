...
class sapAdminPageSettingScheduler_2_1_0 extends sapAdminPageSetting_2_1_0 {
	...
	public function pass_to_scripts() {
		...
		$sap_scheduler_settings[ $this->id ] = array(
			...
			'disable_all_day'	=> $this->disable_all_day,
	...
	public function get_template( $id = 0, $values = array(), $list = false ) {
		...
		<div class="sap-scheduler-rule clearfix<?php echo $list ? ' list' : ''; ?>">
			...
			<div class="sap-scheduler-time <?php echo $this->disable_all_day === true ? 'time-slot' : $time_format; ?>">

				<ul class="sap-selector">
					<li>
						<div class="dashicons dashicons-clock"></div>
						<a href="#" data-format="time-slot"<?php echo $time_format == 'time-slot' || $this->disable_all_day === true ? ' class="selected"' : ''; ?>>
							<?php echo $this->strings['time_label']; ?>
						</a>
					</li>
					<?php if ( $this->disable_all_day === false ) : ?>
					<li>
